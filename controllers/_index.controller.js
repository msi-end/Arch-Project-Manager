...
exports.indexDeshboard = async (req, res) => {
 ...
 WHERE deals.deal_name LIKE '%${req.query.search}%' OR normal_project_cat.category_id LIKE '22' ORDER BY deals.id DESC;`
