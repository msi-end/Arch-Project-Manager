...
function toggleForm(formId) {
 ...
 function GetIncExp() {
  ...
  ReqHandler.GET(location.origin + '/admin/finance/get-income-expense').then((res) => {
      if (res.status) {
          Ctn[0].children[0].children[0].innerText = res.data[0].total_sum
          Ctn[1].children[0].children[0].innerText = res.data[0].cash_sum
          Ctn[2].children[0].children[0].innerText = res.data[0].online_sum}
